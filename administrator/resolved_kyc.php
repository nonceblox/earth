<?php session_start();
   ...
   // Add User Starts Here
      ...
      $headers= "From: Contact Enquiry<website@COINNEST.io>\r\n";
      $headers.= "Reply-To: KYC <kishan@COINNEST.io>\r\n";
