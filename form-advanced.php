                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-6 m-t-sm-40">
                                            ...
                                            <p class="text-muted m-b-20 font-13">
                                                ...
                                                tags input, to gain true multivalue support.
                                                Instead of a comma separated string, the values will be set in an array.
                                                Existing <code>&lt;option /&gt;</code>
                                                elements will automatically be set as tags. This makes it also possible
                                                to create tags containing a comma.
                                            </p>
                                            <div class="m-b-0">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-4 m-t-20">
                                            ...
                                            <div class="switchery-demo">
                                                ...
                                                <input type="checkbox" checked data-plugin="switchery"
                                                       data-color="#ff7aa3"/>
                                                <input type="checkbox" checked data-plugin="switchery"
                                                       data-color="#2b3d51" data-size="large"/>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-6">
                                            <div class="p-20">
                                                ...
                                                <p class="text-muted m-b-15 font-13">
                                                    All you need to do is specify the <code>placement</code> option,
                                                    with one of those strings. If none
