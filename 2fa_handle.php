<?php session_start();
	...
	{		
	  $table = "users";
      $result = $pdo->exec("UPDATE $table SET `g_auth_key`='".$secret."'  WHERE id=".$pdo_auth['id']);      
      add_notification_user("You Enabled KYC", "user", $pdo_auth['id']);  

       $to  = $pdo_auth['email'] . ', '; // note the comma
	   $to .= 'crazykane2000@gmail.com';

	      $subject = 'Your Wallet Account at BBtokens is Now Secured with Google Authentication (2FA)';
	      //// message
	      $headers  = 'MIME-Version: 1.0' . "\r\n";
	      $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	      $headers .= 'To: '.$pdo_auth['name'].' <'.$email.'>' . "\r\n";
	      $headers .= 'From: 2FA Activation  <no-reply@BigBang.com>' . "\r\n";
	     ...
	     $actual_link = "http://$_SERVER[HTTP_HOST]";
	      ...
	      $message = '<!DOCTYPE html>
	        ...
	        <head>
	            ...
	            <title>Google 2FA Now Enabled with Ypur Account  </title> <!-- The title tag shows in email notifications, like Android 4.4. -->
	        ...
	        <body width="100%" bgcolor="#0087e4" style="margin: 0; mso-line-height-rule: exactly;">
	            <center style="width: 100%; background: #0087e4; text-align: left;">
	                ...
	                <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
	                    Your Wallet Account at BBtokens is Now Secured with Google Authentication (2FA)
	                </div>
	                                    ...
	                                    <tr>
	                                        <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
	                                           <p style="margin: 0;">To use conventional banking as an analogy, the blockchain is like a full history of a financial institutions transactions, and each block is like an individual bank statement. But because it is a distributed database system, serving as an open electronic ledger, a blockchain can simplify business operations for all parties.</p>
	                                            ...
	                                            <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #0087e4; font-weight: normal;">Your Wallet Account at BBtokens is Now Secured with Google Authentication (2FA)</h1>
	                                        </td>
	                                    </tr>
	                                    <tr>
	                                                ...
	                                                <tr>
	                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
	                                                        <a href="'.$actual_link.'" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" target="_blank" class="button-a">
	                                                            <span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;&nbsp;&nbsp; Login Account &nbsp;&nbsp;&nbsp;&nbsp;</span>
	                                                        </a>
	                                                    </td>
	                                                </tr>
	                                            </table>
      ...
      header('Location:security.php?choice=success&value=2 Factor Authentication is Now Enabled.');
      exit();
	}
	else
	{
		header('Location:security.php?choice=error&value=Invalid,  Try Again.');
		exit();
	}
