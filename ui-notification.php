                ...
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <div class="row m-t-30">
                            <div class="col-xs-12">
                                <button type="button" class="btn btn-primary waves-effect waves-light" id="showtoast">
                                    Show Toast
                                </button>
                                <button type="button" class="btn btn-danger waves-effect waves-light" id="cleartoasts">
                                    Clear Toasts
                                </button>
